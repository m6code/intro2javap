...
public class ComputeTax{
	public static void main(String[]args){
		...
		//Asks for the filling status
		System.out.println("Please enter your \"filling status\" \n 1. Single \n 2. Married Filling Jointly or Qualifying Widow \n 3. Married Filling Seperately \n 4. Head of House");
		//Recieves filling status
		int fillingStatus = input.nextInt();

		//Recieves Income of the user
		System.out.println("Please enter your income");
		double income = input.nextInt();

		//Compute tax based on the filling status and income
		double tax = 0;
		if (fillingStatus == 1) {
			if (income <= 8350){
				tax = 0.10 * income;
			...
			System.out.println("Please Enter a valid Filling status ID (1,2,3 or 4)");
			System.exit(1);
		}
